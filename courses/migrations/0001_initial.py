    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('COMPLETED', 'اتمام یافته'), ('IN_PROGRESS', 'در حال تکمیل'), ('UPCOMING', 'در حال انتظار'), ('CANCELLED', 'کنسل شده')], max_length=30, verbose_name='وضعیت دوره')),
                ...
                ('learning_path', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='courses', to='courses.learningpath', verbose_name='سطح مسیر آموزشی')),
            ],
            options={
                'verbose_name': 'دوره',
