...
urlpatterns = [
    ...
    path('user/profile/', views.UserProfileViewSet.as_view({'get': 'retrieve', 'patch': 'partial_update'}), name='user-profile'),
    path('user/phone/change/request/', views.ChangePhoneRequestView.as_view(), name='change-phone-request'),
